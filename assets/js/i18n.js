...
const SevaI18n = (() => {
    ...
    const EMBEDDED_LOCALES = {
        en: {
            ...
            "notice.banner_badge": "Under Construction",
            "notice.banner_text": "This site is under construction. All information shown consists of mock data. We will relaunch soon with a full-featured application!",
            "notice.coming_soon": "Coming Soon",
            "notice.demo_mode": "Mock Data",
            "notice.hero_badge": "Notice",
            "notice.hero_msg": "This site is under construction. All information, pricing, and bookings shown are mock data for demonstration. We will relaunch soon with a full-featured application!",
            "nav.home": "Home",
        ...
        mr: {
            ...
            "notice.banner_badge": "साइट निर्माणाधीन आहे",
            "notice.banner_text": "ही साइट सध्या निर्माणाधीन आहे. दर्शविलेली सर्व माहिती मॉक (डेमो) डेटा आहे. आम्ही लवकरच संपूर्ण वैशिष्ट्यांसह नवीन ॲप्लिकेशन लाँच करू!",
            "notice.coming_soon": "लवकरच येत आहे",
            "notice.demo_mode": "मॉक डेटा",
            "notice.hero_badge": "महत्त्वाची नोंद",
            "notice.hero_msg": "ही साइट सध्या निर्माणाधीन आहे. दर्शविलेली सर्व माहिती, किंमती आणि सेवा मॉक डेटा आहेत. आम्ही लवकरच संपूर्ण वैशिष्ट्यांसह नवीन ॲप्लिकेशन लाँच करत आहोत!",
            "nav.home": "मुख्यपृष्ठ",
            "nav.services": "सेवा",
